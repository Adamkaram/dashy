            ...
            <section className="py-16 bg-gradient-to-br from-[#8F6B43] to-[#53131C]">
                <div className="container mx-auto px-4 text-center">
                    <a
                        ...
                        className="inline-flex items-center gap-3 text-white hover:text-white/80 transition-colors text-2xl font-bold"
                    >
                        <span>تابعونا على الإنستغرام</span>
                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-col items-center gap-6">
                        ...
                        <p className="text-sm text-[#46423D]">
                            Copyright © 2025 ماى مومنت جميع الحقوق محفوظة
                        </p>
