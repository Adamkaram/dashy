...
export default function AboutPage() {
    return (
        <div className="min-h-screen bg-[#FFEDD5]" dir="rtl">
            {/* Page Header */}
            ...
            <section className="py-16">
                <div className="container mx-auto px-4 text-center">
                    <h1 className="text-5xl font-bold text-[#FF4F0F] mb-6">عن ماى مومنت</h1>
                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-6">
                            <h2 className="text-4xl font-bold text-[#FF4F0F]">قصتنا</h2>
                        ...
                        <div className="relative">
                            ...
                            <div className="absolute -bottom-6 -right-6 w-64 h-64 bg-[#FF6500] rounded-2xl -z-10" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-16">
                <div className="container mx-auto px-4">
                    <h2 className="text-4xl font-bold text-[#FF4F0F] mb-12 text-center">قيمنا</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        <div className="bg-white rounded-xl p-8 text-center shadow-lg hover:shadow-xl transition-shadow border border-[#FF6500]/10">
                            <div className="inline-flex items-center justify-center w-16 h-16 bg-[#FF4F0F] rounded-full mb-4">
                                <Award className="w-8 h-8 text-white" />
                            </div>
                            <h3 className="text-xl font-bold text-[#FF4F0F] mb-3">الجودة</h3>
                        ...
                        <div className="bg-white rounded-xl p-8 text-center shadow-lg hover:shadow-xl transition-shadow border border-[#FF6500]/10">
                            ...
                            <h3 className="text-xl font-bold text-[#FF4F0F] mb-3">الشغف</h3>
                            <p className="text-[#46423D]">
                        ...
                        <div className="bg-white rounded-xl p-8 text-center shadow-lg hover:shadow-xl transition-shadow border border-[#FF6500]/10">
                            ...
                            <h3 className="text-xl font-bold text-[#FF4F0F] mb-3">الإبداع</h3>
                            <p className="text-[#46423D]">
                        ...
                        <div className="bg-white rounded-xl p-8 text-center shadow-lg hover:shadow-xl transition-shadow border border-[#FF6500]/10">
                            ...
                            <h3 className="text-xl font-bold text-[#FF4F0F] mb-3">الاحترافية</h3>
                            <p className="text-[#46423D]">
            ...
            <section className="py-16">
                <div className="container mx-auto px-4">
                    <h2 className="text-4xl font-bold text-[#FF4F0F] mb-12 text-center">ما نقدمه</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={index} className="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition-all border-r-4 border-[#FF6500]">
                                <h3 className="text-xl font-bold text-[#FF4F0F] mb-3">{service.title}</h3>
                                <p className="text-[#46423D]">
                                    {service.desc}
                                </p>
                            </div>
            ...
            <section className="py-16 bg-[#FFF7ED]">
                <div className="container mx-auto px-4 text-center">
                    <h2 className="text-4xl font-bold text-[#FF4F0F] mb-6">هل أنتم مستعدون لخلق ذكريات لا تُنسى؟</h2>
                    ...
                    <div className="flex gap-4 justify-center flex-wrap">
                        <Link
                            href="/"
                            className="bg-[#FF4F0F] hover:bg-[#FF6500] text-white px-8 py-4 rounded-lg text-lg font-medium transition-colors"
                        >
                            تصفح خدماتنا
                        </Link>
                        <Link
                            href="/contact"
                            className="bg-transparent border-2 border-[#FF4F0F] hover:bg-[#FF4F0F] hover:text-white text-[#FF4F0F] px-8 py-4 rounded-lg text-lg font-medium transition-colors"
                        >
                            اتصل بنا
                        </Link>
                    </div>
